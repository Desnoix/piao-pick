...
class HistorySyncTask(SQLModel, table=True):
    ...
    current_stock: str | None = None  # 当前正在处理的股票代码

    # 错误记录
    error_messages: str | None = None  # JSON array of error messages
    ...
    def update_progress(self, completed: int, failed: int, total_klines: int, current_stock: str | None = None):
        """更新进度"""
